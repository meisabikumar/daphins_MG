 ...
 *
 */
	var ColorPicker = function(defaultId,defaultImgId) {
		...
		updateBaseColor(presets[defaultId].baseColor);
		updateHighlightColor(presets[defaultId].highlightColor);
		updateTextColor(presets[defaultId].textColor);
		updateTextGlowColor(presets[defaultId].textGlowColor, presets[defaultId].textGlowColor.a);
		//updateTextGlowColor({r: hexToRgb().r, g: hexToRgb().g, b: hexToRgb().b}, '0.5');
