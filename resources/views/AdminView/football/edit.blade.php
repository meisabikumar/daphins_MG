            ...
            <div class="box-body ">
                ...
                <div class="col-md-12">
                    ...
                    <div class="tile">
                        ...
                        <form class="add-form" method="post" action="{{url('/admin/football/contest/edit/'. $id) }}'">
                                    ...
                                    <div class="col-md-4 normal-entry ">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="min_entry" id="min_entry" class="form-control"
                                                placeholder="Min. entry" value="{{ $r->min_entry }}">
                                    ...
                                    <div class="col-md-4 normal-entry">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="max_entry" id="max_entry" class="form-control"
                                                placeholder="Max. entry" value="{{ $r->max_entry }}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <span class="input-group-text" id="basic-addon1">$</span>
                                                ...
                                                <input type="text" name="entry_fee" id="entry_fee" class="form-control"
                                                    placeholder="Entry Fee" value="{{ $r->entry_fee }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            @if (!empty($r->admin_per))
                                                <div class="input-group">
                                                    ...
                                                    <input type="radio" class="choose-comm-type" id="amt_type"
                                                        name="amt_type" value="per" checked> &nbsp;
                                    ...
                                    <div class="col-md-4 " style="">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="admin_fix" id="admin_fix" class="form-control"
                                                    placeholder="Admin Commission (Fixed Amount)"
                                                    value="{{ $r->admin_amt }}">
                                        ...
                                        <span class="input-group-text">%</span>
                                            ...
                                            <input type="hidden" name="admin_fix_amt" id="admin_fix_amt"
                                                value="{{ $r->admin_amt }}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                            ...
                                            <label>
                                                @if ($r->is_free == 1)
                                                    <input type="checkbox" name="is_free" id="is_free" value="1"
                                                        checked><span class="label-text">Free Contest</span>
                                                @else
                                            ...
                                            <label>
                                                @if ($r->is_featured == 1)
                                                    <input type="checkbox" name="is_featured" id="is_featured" value="1"
                                                        checked><span class="label-text">Featured Contest</span>
                                                @else
                                                    <input type="checkbox" name="is_featured" id="is_featured"
                                                        value="1"><span class="label-text">Featured Contest</span>
                                                @endif
                                        ...
                                        <div class="animated-checkbox">
                                            ...
                                            <label>
                                                @if ($r->is_confirmed == 1)
                                                    <input type="checkbox" name="is_confirmed" id="is_confirmed" value="1"
                                                        checked><span class="label-text">Is Confirmed?</span>
                                                @else
                                                    <input type="checkbox" name="is_confirmed" id="is_confirmed"
                                                        value="1"><span class="label-text">Is Confirmed?</span>
                                                @endif
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="entry_per_user" class="form-control"
                                                id="entry_per_user" placeholder="Entry per User"
                                                value="{{ $r->entry_per_user }}">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <?php
                                            $k = json_decode($r->breakdown);
                                            ?>
                                            @if ( !empty($k[0]->prize_per) && ($k[0]->prize_per) != null )
                                                <div class="input-group">

                                                    <input type="radio" class="choose-prize-distribution" id="prize_type"
                                                        name="prize_type" value="per" checked> &nbsp;
                ...
                @endforeach
                            ...
                            {{-- <button type="submit" class="btn btn-primary" value="submit" id="a"> Submit </button> --}}
