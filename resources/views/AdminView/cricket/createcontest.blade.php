...
<section class="content">
    ...
    <div class="col-md-12">
        ...
        <div class="tile">
    	  	...
    	  	<form class="add-form" method="post" action="{{url('/admin/contests/cric_create/add')}}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" readonly class="form-control" name="winning_amt" id="winning_amt" value="">
